...
const navItems: { tab: AdminTab; label: string; icon: React.ElementType; group: string }[] = [
  ...
  { tab: 'emailVerifier', label: 'Email Diagnostics', icon: Mail, group: 'system' },
]
