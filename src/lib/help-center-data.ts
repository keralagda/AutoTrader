...
export const ADMIN_HELP_GUIDES: HelpGuide[] = [
  ...
  { id: 'a47', title: 'VIP Tier System', category: 'Advanced', audience: 'admin', content: 'Users progress through tiers (Bronze → Silver → Gold → Platinum → Diamond) based on NP earned. Each tier provides cashback on deposits. Tiers are automatic based on NP thresholds.' },
